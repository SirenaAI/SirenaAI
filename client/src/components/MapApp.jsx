...
const MapApp = () => {
  ...
  const handleLogout = () => {
    if (window.confirm(t('mapApp.confirmLogout'))) {
      logout()
      navigate('/')
    }
  }
        ...
        <aside className="sidebar">
          <div className="sidebar-header">
            ...
            <button 
              ...
              aria-label={t('mapApp.closeSidebar')}
            >
          ...
          <div className="sidebar-content">
            <span className="sidebar-menu-label body-medium">{t('mapApp.menu')}</span>
            <nav className="sidebar-nav">
              <Link to="/" className="sidebar-nav-item">
                ...
                <span className="body-medium">{t('mapApp.home')}</span>
              </Link>
              <Link to="/app" className="sidebar-nav-item active">
                ...
                <span className="body-medium">{t('mapApp.map')}</span>
              </Link>
              <Link to="/contacto" className="sidebar-nav-item">
                ...
                <span className="body-medium">{t('mapApp.contact')}</span>
              </Link>
            </nav>
          </div>
          ...
          <div className="sidebar-footer">
            ...
            <button className="logout-btn" onClick={handleLogout}>
              ...
              <span className="body-medium">{t('mapApp.logout')}</span>
            </button>
          </div>
        </aside>
      )}
        ...
        <div className="map-topbar">
          {!sidebarOpen && (
            <button 
              ...
              aria-label={t('mapApp.openSidebar')}
            >
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M5 8h20M5 15h20M5 22h20"/>
              </svg>
          ...
          <div className="search-bar">
            ...
            <input
              type="text"
              placeholder={t('mapApp.searchPlaceholder')}
              value={searchQuery}
