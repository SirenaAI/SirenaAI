      ...
      <div className="footer-container">
        <div className="footer-about">
          ...
          <p className="body-medium text-muted">
            ...
            inundación. Nuestro objetivo es ofrecer datos confiables que ayuden a
            prevenir desastres y fortalecer la resiliencia de las comunidades.
          </p>
        </div>
        ...
        <div className="footer-social">
          ...
          <div className="footer-links">
            ...
            <a href="https://github.com/SirenaAI/SirenaAI" target="_blank" rel="noopener noreferrer" className="footer-link">
